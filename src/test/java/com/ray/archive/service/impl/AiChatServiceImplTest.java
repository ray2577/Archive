...
class AiChatServiceImplTest {
    ...
    void processQuery_ValidInput_ReturnsResult() {
        ...
        // Act
        Map<String, Object> result = aiChatService.processQuery(query, userId);
    ...
    void processQuery_EmptyQuery_ThrowsException() {
        ...
        assertThrows(IllegalArgumentException.class, () -> {
            aiChatService.processQuery(query, userId);
        });
    }
    ...
    void getChatHistory_ValidInput_ReturnsHistory() {
        ...
        when(chatHistoryRepository.findByUserIdOrderByCreateTimeDesc(eq(userId), any(PageRequest.class)))
